 ...
 */
public class PlayNowFragment extends Fragment implements LoaderManager.LoaderCallbacks<ArrayList<Movie>> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_play_now, container, false);
        rvCategory = (RecyclerView)rootView.findViewById(R.id.rv_category);
        rvCategory.setHasFixedSize(true);

        getActivity().setTitle(getResources().getString(R.string.playnow));
    ...
    public Loader<ArrayList<Movie>> onCreateLoader(int i, @Nullable Bundle bundle) {
        ...
        return new MyAsyncTaskLoader(getContext(), "", MyAsyncTaskLoader.TYPE_NOW);
    }
