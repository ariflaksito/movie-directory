package net.ariflaksito.moviedirectory.Provider;
...
import net.ariflaksito.moviedirectory.Widgets.StackWidgetService;
...
public class ImageWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "net.ariflaksito.TOAST_ACTION";
    public static final String EXTRA_ITEM = "net.ariflaksito.EXTRA_ITEM";
